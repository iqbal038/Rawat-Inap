    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            <button class="btn btn-primary" data-toggle="modal" data-target="#tambahBukuModal">
                <i class="fa fa-plus">  Tambah Data Rawat Inap</i>
            </button>
            <hr>
            <table id="table-data" class="table table-bordered">
                <thead>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class= "modal-title" id="exampleModalLabel">Tambah Data Rawat Inap</5>
                                ...
                                <div class="modal-body">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <label for="penulis">Kode Inap</label>
                                        ...
                                        <div class="form-group">
                                        <label for="tahun">Kode Ruangan</label>
                                            <input type="year"class="form-control" name="tahun" id="tahun" required/>
                                        </div>
                                        <div class="form-group">
                                        <label for="cover">Kode Dokter</label>
